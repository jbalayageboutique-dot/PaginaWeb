      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="pt-1 flex items-center gap-2">
              <span className="bg-[#BFA181]/15 text-[#BFA181] px-2.5 py-1 rounded border border-[#BFA181]/30 font-bold flex items-center gap-1">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5 text-stone-300">
              {GOOGLE_BUSINESS_DATA.openingHours.map((h, i) => (
                <div key={i} className="flex justify-between border-b border-[#2A2A2A] pb-1">
                  <span>{h.days}:</span>
        ...
        <div className="pt-8 border-t border-[#2A2A2A] flex flex-col sm:flex-row items-center justify-between gap-4 text-stone-500 text-[11px]">
          ...
          <p className="flex items-center gap-1">
            ...
            <span className="text-stone-300 font-medium">Estudio Balayage</span>
          </p>
        </div>
