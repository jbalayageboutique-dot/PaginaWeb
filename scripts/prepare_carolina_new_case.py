...
CASE_INFO = {
    ...
    "title": "Balayage Rubio Cálido con Olaplex | Caso Carolina Rubio",
    "description": "Transformación de cabello oscuro natural a un balayage rubio cálido luminoso con contorno iluminado. Se utilizó el tratamiento completo de Olaplex para cuidar la fibra capilar, sellado de cutícula e hidratación profunda para dar máximo brillo y suavidad en Maison Balayage Studio, Punta Arenas.",
    "keywords": "balayage rubio calido, olaplex Punta Arenas, cabello natural oscuro a rubio, contorno iluminado, sellado de cuticula, hidratacion profunda cabello, peluqueria Punta Arenas, Maison Balayage Studio",
}
...
def main():
    src_dir = Path("/Users/janet/Downloads/carpetacarolina balayage sin título")
    if not src_dir.exists():
        print(f"Error: Source directory {src_dir} does not exist.")
        return

    # Workspace paths
    ws_dir = Path("/Users/janet/Documents/IA/WEBSITE JBALAYAGE/carolina-balayage-rubio-calido-olaplex-punta-arenas")
    ...
    dl_dest_dir = Path("/Users/janet/Downloads/carolina-balayage-rubio-calido-olaplex-punta-arenas")
    ...
    # Define mappings based on timing and inspection
    mappings = [
        # Photo BEFORE (natural hair)
        {"src": "d4a0ff29-b69c-43fd-92c3-82f4a1ea20c9.jpg", "type": "photo", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-antes-del-cambio-01.jpg"},
        # Photo PORTADA AFTER (Instagram beauty shot)
        {"src": "5B81FCFD-D6DC-4300-A061-3D437827A20A.JPG", "type": "photo", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-portada-despues-01.jpg"},
        
        # Photo GALLERY ESPEJO (IA fix)
        {"src": "35B627CC-EA05-4A6A-AFB6-8D124335A42E.PNG", "type": "photo", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-espejo-ia-01.png"},
        # Photo GALLERY DETALLE (IA fix)
        {"src": "D5452875-965F-4CB2-A552-8A957F12CA54.PNG", "type": "photo", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-detalle-ia-02.png"},
        
        # Photo GALLERY OTHER
        {"src": "7B79C5E8-ADB9-47A5-8FAB-10DFF84EF93D.PNG", "type": "photo", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-despues-01.png"},
        {"src": "8B6B7843-08A2-409B-BC72-DCC310AA2462.PNG", "type": "photo", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-despues-02.png"},
        {"src": "9CBD306E-9D7D-4C96-AD99-665B3605A050.PNG", "type": "photo", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-despues-03.png"},
        {"src": "DBEA03F1-D122-4208-BC4D-A2140A062320.PNG", "type": "photo", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-despues-04.png"},
        
        # Videos
        {"src": "IMG_4236.MOV", "type": "video", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-movimiento-01.mov"},
        {"src": "IMG_4237.mov", "type": "video", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-movimiento-02.mov"},
        {"src": "IMG_4239.MOV", "type": "video", "new_name": "maison-balayage-punta-arenas-carolina-balayage-rubio-calido-movimiento-03.mov"},
    ]

    manifest = []
    
    print("Iniciando procesamiento de archivos para el nuevo caso Carolina...")
    ...
    manifest_path = ws_dir / "metadata-manifest-carolina-nuevo.json"
    manifest_path.write_text(json.dumps(manifest, indent=2, ensure_ascii=False))
    
    # Write README.md to workspace
    readme_content = f"""# Caso Carolina Rubio — Balayage Rubio Cálido con Olaplex

## Resumen del Caso

- **Nombre del Cliente:** Carolina (Rubio)
- **Problemática/Objetivo:** Carolina llegó al salón con una base oscura natural y cabello muy sano. Deseaba una transformación profunda para ser rubia con contorno en tonos cálidos.
- **Procedimiento técnico:**
  - Balayage completo cuidando la degradación.
  - Uso riguroso de la línea completa de **Olaplex** en cada paso del proceso de decoloración y matizado para preservar la fibra capilar de cualquier daño.
  - Sellado de cutícula posterior con tratamiento completo de hidratación profunda para dar un brillo y suavidad excepcionales.
  - Contorno frontal en colores cálidos para una iluminación suave y natural del rostro.
